...
using Tyuiu.SvitkovIA.Sprint3.Task5.V9.Lib;

namespace Tyuiu.SvitkovIA.Sprint3.Task5.V9
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Формула при х = 5. Название проектов (консольного приложения,           *");
            Console.WriteLine("* библиотеки классов, тестового модуля) оформить по шаблону с вариантом.  *");
            Console.WriteLine("*                                                                         *");
